...
public class CustomerDaoImpl implements CustomerDao {
	...
	public void addCustomer(Customer customer) {
		...
		// utworzenie nowego użytkownika oraz ustawienie atrybutów
		...
		// Utworzenie nowego wpisu z rolami oraz ustawienie z roli użytkownika
		Authorities authority = new Authorities();
		authority.setUsername(customer.getUsername());
		authority.setAuthority("ROLE_USER");

		// utrwalenie użytkownika oraz jego roli
